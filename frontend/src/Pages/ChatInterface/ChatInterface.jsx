...
const ChatInterface = () => {
  ...
  const username =
    location.state?.username || sessionStorage.getItem("username") || "User";
  const email =
    location.state?.email || sessionStorage.getItem("email") || "userEmail";
      ...
      >
        ...
        >
          <svg
            ...
            height="3em"
            viewBox="0 0 24 24"
            className="border-2 bg-white border-gray-300 rounded-full p-2"
          >
            <path
              fill="none"
              stroke="black"
        ...
        <div className="">
          <svg
            ...
            height="3em"
            viewBox="0 0 24 24"
            className="mt-5 border-2 bg-white border-gray-300 rounded-full p-2"
          >
      ...
      <div className="flex flex-col w-full bg-white">
        ...
        <div className="flex items-center justify-between m-5 font-outfit">
          <div className="flex items-center">
            ...
            />
            <div className="ml-3">
              <p className="poppins-semibold">Copsify</p>
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="poppins-regular">Always active</p>
              </div>
            </div>
          </div>
          <div onClick={() => setModalVisible(!modalVisible)}>
            ...
            {modalVisible && (
              <div
                ref={modalRef}
                className="absolute poppins-regular bg-white p-3 shadow-lg rounded-lg right-10 top-28 z-50"
              >
                <p>{email}</p>
                <p className="mb-2">{username}</p>
                <hr />
                <button
                  className="bg-red-600 pl-2 pr-4 text-sm mt-2 flex items-center gap-2 rounded text-white py-1"
                  onClick={() => {
          ...
          <div>
            <div className="pl-10 pb-2 bg-white flex flex-col items-center">
              <h1 className="md:text-5xl text-2xl font-semibold text-gray-600">
                <span className="text-gradient">Hello, {username}</span>
              </h1>
              <p className="text-gray-500 mt-2 md:text-5xl text-2xl">
            ...
            <div className="px-5 pt-5">
              <div className="grid md:grid-cols-4 grid-cols-2 gap-4 ">
                {examplePrompts.map((prompt, index) => (
                  <div
                    key={index}
                    className="border-2 border-gray-400 p-4 rounded-lg  cursor-pointer"
        ...
        <div className="p-4  flex items-center">
          <form onSubmit={handleSubmit} className="flex w-full">
            <input
              ...
              className="flex-grow p-3 rounded-full bg-white shadow-sm border border-gray-200 focus:outline-none"
            />
            <button
              type="button"
